<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Food_Order_System.Products" %>
        ...
        <header>
            <nav class="nav">
                    ...
                    <section class="well well__offset-1 bg-1">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-7"><asp:Label Text="" runat="server" ID="Label1"></asp:Label></div>
                                <div class="col-md-1">
                                 ...
                                 <div class="col-md-1">
                                    <a href="Home.aspx">My Order</a>  
                                </div> 
                                <div class="col-md-1">
                                    <a href="Home.aspx">My Cart</a>  
                                </div>
                                <div class="col-md-1">
